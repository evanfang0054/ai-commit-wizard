...
class GitService {
        ...
        this.git = (0, simple_git_1.default)({
            ...
            progress: ({ method, stage, progress }) => {
                if (method && (method.includes('push') || method.includes('commit'))) {
                    console.log(`${method} ${stage !== null && stage !== void 0 ? stage : ''} ${progress !== null && progress !== void 0 ? progress : ''}`);
                }
            }
    ...
    async commit(message) {
        ...
        console.log(constants_1.PROMPTS.success.commit);
    }
    /**
     * 推送到远程仓库
     *
    ...
    async push() {
        try {
            ...
            if (error.message.includes('no upstream branch')) {
                console.log(constants_1.PROMPTS.push.noUpstream);
        ...
        console.log(constants_1.PROMPTS.success.push);
    }
    /**
     * 获取暂存区文件的详细变更
     *
